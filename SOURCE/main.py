...
class miApp(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("PROMATERIAL+ - GUI for materials science ")
        ...
        self.lbTitle.setPixmap(QtGui.QPixmap("Title.png"))
...
class vOperacion(QDialog):
    def __init__(self):
        ...
        self.lbWrite.setPixmap(QtGui.QPixmap("TextWES.png"))
        self.lbFondo.setPixmap(QtGui.QPixmap("fondo.jpg"))
